...
def plot_view(request):
    ...
    deidentify_dataset('service_account_json.json', 'prefab-shape-235820', 'northamerica-northeast1', 'HealthCareData', 'DeId2')
    export_bigquery('service_account_json.json', 'prefab-shape-235820','northamerica-northeast1','DeId2', 'FHIRdata', 'prefab-shape-235820.queryDeId1')
    test_table_exists2()
    delete_dataset('service_account_json.json', 'prefab-shape-235820', 'northamerica-northeast1', 'DeId2')
...
def data_create_view(request):
    ...
    if form.is_valid():
        ...
        resp, idP = create_resourcePatient('service_account_json.json', 'https://healthcare.googleapis.com/v1beta1',
                                           'prefab-shape-235820', 'northamerica-northeast1', 'HealthCareData',
                                           'FHIRdata', 'Patient', form['FirstName'].value(), form['LastName'].value(), form['Gender'].value())
        create_resourceProcedure('service_account_json.json', 'https://healthcare.googleapis.com/v1beta1', 'prefab-shape-235820',
    ...
    #export_bigquery('service_account_json.json', 'prefab-shape-235820','northamerica-northeast1','DeId2', 'FHIRdata', 'prefab-shape-235820.queryDeId1')
    #delete_resource('service_account_json.json', 'https://healthcare.googleapis.com/v1beta1', 'prefab-shape-235820',
       #             'northamerica-northeast1', 'HealthCareData', 'FHIRdata', 'Procedure', '26ab3467-b378-4f2c-8804-3a9599ecc003' )
    #get_resource('service_account_json.json', 'https://healthcare.googleapis.com/v1beta1', 'prefab-shape-235820',
                # 'northamerica-northeast1', 'HealthCareData', 'FHIRdata', 'Procedure', 'b32fe1a1-aa55-45d2-b2c1-198e539377b1')
    #get_resource('service_account_json.json', 'https://healthcare.googleapis.com/v1beta1', 'prefab-shape-235820','northamerica-northeast1','DeId2', 'FHIRdata', 'Procedure', 'b32fe1a1-aa55-45d2-b2c1-198e539377b1')
...
def test_table_exists2():
    ...
    client.delete_dataset('prefab-shape-235820.queryDeId1', delete_contents=True, not_found_ok=True)
    dataset = bigquery.Dataset('prefab-shape-235820.queryDeId1')
    dataset.location = "US"
